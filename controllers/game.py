...
###-------create part done-------------------------------------
        ...
        while (start_game==False):
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if 79 < x < 255 and 248 < y < 338: # start game
                        self.load_game()
                    elif 282 < x < 400 and 303 < y < 369: # scoreboard
                        webbrowser.open_new("https://localhost:5000/scoreboard")
                    elif 591 < x < 687 and 337 < y < 372: # about
                        webbrowser.open_new("https://localhost:5000/about")
    ...
    def endgame(self):
        self.GAMEOVER = True
        endimg =  pygame.image.load('./imgs/gameover.png')
